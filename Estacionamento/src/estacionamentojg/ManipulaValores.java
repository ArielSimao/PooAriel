...
public class ManipulaValores extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (a == true) {// trata os dois valores informados pelo usuario
            new Estacionamento(trata(this.jTextField1.getText()), trata(this.jTextField2.getText()));
            this.dispose();
        }
        else
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new Estacionamento(2.0, 1.0);//define valores 2.0 para primeirahora e 1.0 para precohora
